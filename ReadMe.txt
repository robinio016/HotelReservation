========================================================================
    APPLICATION : Vue d'ensemble du projet HotelReservation
========================================================================

AppWizard a créé cette application HotelReservation pour vous.  

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application HotelReservation.

HotelReservation.vcxproj
...
HotelReservation.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé HotelReservation.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
